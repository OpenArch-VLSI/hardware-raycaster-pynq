...
HD_PWD='C:/Users/nayak/hardware-raycaster-pynq/vivado/project/hardware_raycast_pynq.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pynq_test_pattern_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pynq_test_pattern_top.tcl -notrace
