...
HD_PWD='C:/Users/nayak/hardware-raycaster-pynq/vivado/project/hardware_raycast_pynq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pynq_test_pattern_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pynq_test_pattern_top.tcl
